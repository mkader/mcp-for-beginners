...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:52:13+00:00",
...
**মডেল কনটেক্সট প্রোটোকল (MCP)** একটি আধুনিক ফ্রেমওয়ার্ক যা AI মডেল এবং ক্লায়েন্ট অ্যাপ্লিকেশনের মধ্যে যোগাযোগকে মানসম্মত করার জন্য ডিজাইন করা হয়েছে। এই ওপেন-সোর্স শিক্ষাক্রমটি একটি গঠনমূলক শেখার পথ প্রদান করে, যেখানে রয়েছে বাস্তব কোড উদাহরণ এবং জনপ্রিয় প্রোগ্রামিং ভাষাগুলিতে বাস্তব জীবনের ব্যবহারিক কেস, যেমন C#, Java, JavaScript, TypeScript, এবং Python।

আপনি যদি AI ডেভেলপার, সিস্টেম আর্কিটেক্ট, বা সফটওয়্যার ইঞ্জিনিয়ার হন, তাহলে MCP এর মৌলিক বিষয় এবং বাস্তবায়ন কৌশল আয়ত্ত করার জন্য এই গাইডটি আপনার জন্য একটি সম্পূর্ণ রিসোর্স।
...
| 3.3 | LLM সহ ক্লায়েন্ট | বড় ভাষার মডেল ইন্টিগ্রেশন করুন | [গাইড](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | VS Code ইন্টিগ্রেশন | MCP সার্ভার VS Code-এ ব্যবহার করুন | [গাইড](./03-GettingStarted/04-vscode/README.md) |
...
| 3.10 | উন্নত সার্ভার ব্যবহার | উন্নত বৈশিষ্ট্য এবং উন্নত আর্কিটেকচারের জন্য উন্নত সার্ভার ব্যবহার করুন | [গাইড](./03-GettingStarted/10-advanced/README.md) |
...
| 5.13 | Foundry ইন্টিগ্রেশন | Azure AI Foundry এর সাথে ইন্টিগ্রেশন | [গাইড](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 11 | MCP সার্ভার ডাটাবেস ইন্টিগ্রেশন | PostgreSQL ইন্টিগ্রেশনের জন্য 13-ল্যাব হাতে-কলমে শেখার পথ | [ল্যাব](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.6 | MCP সার্ভার ইমপ্লিমেন্টেশন | ডাটাবেস ইন্টিগ্রেশনের সাথে FastMCP সার্ভার তৈরি | [ল্যাব ০৫](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | টুল ডেভেলপমেন্ট | ডাটাবেস কোয়েরি টুল এবং স্কিমা ইনট্রোস্পেকশন তৈরি | [ল্যাব ০৬](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
- C#, Java, JavaScript, Python, বা TypeScript-এর অন্তত একটি ভাষায় প্রোগ্রামিংয়ের মৌলিক জ্ঞান
...
একটি বিস্তারিত [স্টাডি গাইড](./study_guide.md) উপলব্ধ যা আপনাকে এই রিপোজিটরিতে কার্যকরভাবে নেভিগেট করতে সাহায্য করবে। গাইডে রয়েছে:
...
MCP Dev Days-এ দুই দিনের গভীর প্রযুক্তিগত অন্তর্দৃষ্টি, কমিউনিটি সংযোগ এবং হাতে-কলমে শেখার জন্য প্রস্তুত হন। এটি Model Context Protocol (MCP)-এর জন্য একটি ভার্চুয়াল ইভেন্ট, যা AI মডেল এবং তাদের নির্ভরশীল টুলগুলির মধ্যে সেতু তৈরি করে।
...
ডেভেলপারদের তাদের ডেভেলপার ওয়ার্কফ্লোতে MCP ব্যবহার করতে এবং অসাধারণ MCP কমিউনিটি উদযাপন করার জন্য। আমরা Arcade, Block, Okta, এবং Neon-এর মতো কমিউনিটি সদস্য এবং অংশীদারদের সাথে যোগ দেব, যারা Microsoft-এর সাথে সহযোগিতা করে একটি ওপেন, এক্সটেনসিবল MCP ইকোসিস্টেম তৈরি করছে।  
বাস্তব-জীবনের ডেমো VS Code, Visual Studio, GitHub Copilot এবং জনপ্রিয় কমিউনিটি টুলগুলির উপর ভিত্তি করে  
প্র্যাকটিক্যাল, কনটেক্সট-ড্রিভেন ডেভেলপমেন্ট ওয়ার্কফ্লো  
...
এটি MCP নির্মাতাদের জন্য। আমরা MCP সার্ভার তৈরি এবং MCP-কে AI ওয়ার্কফ্লোতে একীভূত করার জন্য ইমপ্লিমেন্টেশন কৌশল এবং সেরা অনুশীলন নিয়ে গভীর আলোচনা করব।
...
ইন্টেনসিভ ভিডিও সেশনে শিখুন কীভাবে MCP সার্ভার তৈরি করবেন, VS Code-এর সাথে একীভূত করবেন এবং MCP ফর বিগিনারস কারিকুলামের বিষয়বস্তু অনুযায়ী Azure-এ পেশাদারভাবে ডিপ্লয় করবেন। একটি প্রযুক্তি সম্পর্কে ব্যবহারিক দক্ষতা অর্জন করুন যা বড় কোম্পানিগুলি ইতিমধ্যেই ব্যবহার করছে।
...
এই প্রকল্প কন্ট্রিবিউশন এবং পরামর্শকে স্বাগত জানায়। বেশিরভাগ কন্ট্রিবিউশন আপনাকে একটি  
Contributor License Agreement (CLA) সম্মত হতে হবে যা ঘোষণা করে যে আপনার অধিকার রয়েছে এবং আপনি আমাদের  
আপনার কন্ট্রিবিউশন ব্যবহার করার অধিকার প্রদান করেন। বিস্তারিত জানতে <https://cla.opensource.microsoft.com> দেখুন।

যখন আপনি একটি পুল রিকোয়েস্ট জমা দেন, একটি CLA বট স্বয়ংক্রিয়ভাবে নির্ধারণ করবে যে আপনাকে CLA প্রদান করতে হবে কিনা এবং PR-এ যথাযথভাবে সাজাবে (যেমন, স্ট্যাটাস চেক, মন্তব্য)। বট দ্বারা প্রদত্ত নির্দেশনা অনুসরণ করুন। আপনাকে এটি শুধুমাত্র একবার করতে হবে সমস্ত রিপোতে যা আমাদের CLA ব্যবহার করে।
...
- **কোর কারিকুলাম (00-11)**: মূল বিষয়বস্তু যা এগারো ক্রমাগত মডিউলে সংগঠিত, যার মধ্যে রয়েছে বিস্তৃত ডাটাবেস ইন্টিগ্রেশন ল্যাব
...
- **images/**: কারিকুলামের জুড়ে ব্যবহৃত ডায়াগ্রাম এবং চিত্র
...
এই প্রকল্পে প্রকল্প, পণ্য বা পরিষেবার জন্য ট্রেডমার্ক বা লোগো থাকতে পারে। Microsoft ট্রেডমার্ক বা লোগোর অনুমোদিত ব্যবহার অবশ্যই [Microsoft-এর ট্রেডমার্ক ও ব্র্যান্ড নির্দেশিকা](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) অনুসরণ করতে হবে। এই প্রকল্পের পরিবর্তিত সংস্করণে Microsoft ট্রেডমার্ক বা লোগোর ব্যবহার বিভ্রান্তি সৃষ্টি করা উচিত নয় বা Microsoft-এর পৃষ্ঠপোষকতার ইঙ্গিত করা উচিত নয়। তৃতীয় পক্ষের ট্রেডমার্ক বা লোগোর যেকোনো ব্যবহার সেই তৃতীয় পক্ষের নীতিমালার অধীন।
