...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T15:08:16+00:00",
...
| 3.10 | Pokročilé používanie servera | Používanie pokročilých serverov na pokročilé funkcie a zlepšenú architektúru | [Sprievodca](./03-GettingStarted/10-advanced/README.md) |
...
| 05 | Pokročilé témy v MCP | Multimodálne AI, škálovanie, použitie v podnikoch | [Čítajte viac](./05-AdvancedTopics/README.md) |
...
| 11.10 | Integrácia s VS Code | Konfigurácia VS Code MCP integrácie a používanie AI Chat | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
| TypeScript | Príklad aplikácie v kontajneri | [Zobraziť kód](./04-PracticalImplementation/samples/typescript/README.md) |

## 🎯 Predpoklady na učenie MCP

Aby ste z tejto učebnej osnovy vyťažili maximum, mali by ste mať:
...
Komplexný [Študijný sprievodca](./study_guide.md) je k dispozícii na pomoc pri navigácii v tomto repozitári. Sprievodca obsahuje:

- Vizualizovanú mapu učebnej osnovy so všetkými pokrytými témami
- Podrobný rozpis každej sekcie repozitára
- Pokyny na používanie ukážkových projektov
...
Je zameraný na posilnenie vývojárov pri používaní MCP vo svojom vývojovom pracovnom toku a oslavu úžasnej MCP komunity. Pripoja sa k nám členovia komunity a partneri ako Arcade, Block, Okta a Neon, aby ukázali, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného MCP ekosystému. 
...
Naučte sa v intenzívnych video reláciách, ako vytvárať MCP servery, integrovať ich s VS Code a profesionálne nasadzovať na Azure na základe obsahu z MCP pre začiatočníkov. Získajte praktické zručnosti v technológii, ktorú už používajú veľké spoločnosti.
...
Poďme sa naučiť o Model Context Protocol (MCP), špičkovom rámci navrhnutom na štandardizáciu interakcií medzi AI modelmi a klientskými aplikáciami. Prostredníctvom tejto relácie pre začiatočníkov vás zoznámime s MCP a prevedieme vás vytvorením vášho prvého MCP servera.
...
CLA a ozdobí PR primerane (napr. kontrola stavu, komentár). Jednoducho postupujte podľa pokynov
...
Ak máte spätnú väzbu k produktu alebo narazíte na chyby počas vytvárania, navštívte:
