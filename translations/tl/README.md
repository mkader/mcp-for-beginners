...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T14:53:53+00:00",
...
[![Mga Contributor sa GitHub](https://img.shields.io/github/contributors/microsoft/mcp-for-beginners.svg)](https://GitHub.com/microsoft/mcp-for-beginners/graphs/contributors)
...
[![Malugod na Tinatanggap ang PRs](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
...
- 📘 [Dokumentasyon ng MCP](https://modelcontextprotocol.io/) – Mga detalyadong tutorial at user guide  
...
| 3.10 | Advanced na paggamit ng server | Gumamit ng advanced na mga server para sa mas mahusay na feature at arkitektura | [Gabay](./03-GettingStarted/10-advanced/README.md) |
...
| 11 | Integrasyon ng MCP Server Database | Komprehensibong 13-lab na landas sa pag-aaral para sa integrasyon ng PostgreSQL | [Labs](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | Panimula | Pangkalahatang-ideya ng MCP na may integrasyon ng database at retail analytics na kaso ng paggamit | [Lab 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.12 | Pag-monitor | Application Insights, logging, at pag-monitor ng performance | [Lab 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
...
Para sa mga tagabuo ng MCP. Magpapalalim kami sa mga estratehiya sa implementasyon at pinakamahusay na mga praktika para sa paglikha ng MCP servers at integrasyon ng MCP sa iyong mga workflow ng AI.
...
Matuto sa mga intensive na video session kung paano gumawa ng MCP servers, mag-integrate sa VS Code, at mag-deploy nang propesyonal sa Azure batay sa nilalaman mula sa MCP for Beginners curriculum. Magkaroon ng praktikal na kasanayan sa teknolohiyang ginagamit na ng mga malalaking kumpanya.
...
Alamin ang tungkol sa Model Context Protocol (MCP), isang cutting-edge na framework na idinisenyo upang i-standardize ang interaksyon sa pagitan ng mga AI model at client applications. Sa beginner-friendly na session na ito, ipakikilala namin sa iyo ang MCP at gagabayan ka sa paggawa ng iyong unang MCP server.
...
Salamat kay Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) para sa mahalagang kontribusyon sa mga sample na code. 
...
- **11-MCPServerHandsOnLabs/**: Kumpletong 13-lab na learning path para sa pagbuo ng production-ready MCP servers na may PostgreSQL integration
