...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:48:40+00:00",
...
| 3.10 | उन्नत सर्वर उपयोग | उन्नत सुविधाओं और बेहतर आर्किटेक्चर के लिए उन्नत सर्वर का उपयोग करें | [गाइड](./03-GettingStarted/10-advanced/README.md) |
...
| 11.1 | परिचय | MCP का डेटाबेस एकीकरण और रिटेल एनालिटिक्स उपयोग केस का अवलोकन | [लैब 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.6 | MCP सर्वर कार्यान्वयन | FastMCP सर्वर का निर्माण और डेटाबेस इंटीग्रेशन | [लैब 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | टूल विकास | डेटाबेस क्वेरी टूल्स और स्कीमा इन्ट्रोस्पेक्शन बनाना | [लैब 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
| भाषा | विवरण | लिंक |
|------|-------|------|
| C# | एडवांस्ड नमूना | [कोड देखें](./04-PracticalImplementation/samples/csharp/README.md) |
| Java with Spring | कंटेनर ऐप उदाहरण | [कोड देखें](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | एडवांस्ड नमूना | [कोड देखें](./04-PracticalImplementation/samples/javascript/README.md) |
...
यह रिपॉजिटरी कई संसाधन प्रदान करती है जो आपको प्रभावी ढंग से सीखने में मदद करती है:
...
MCP Dev Days के लिए तैयार हो जाइए, एक वर्चुअल इवेंट जो मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) पर गहन तकनीकी जानकारी, सामुदायिक कनेक्शन, और हैंड्स-ऑन सीखने के लिए समर्पित है।  
...
- VS कोड, Visual Studio, GitHub Copilot, और लोकप्रिय सामुदायिक टूल्स में वास्तविक दुनिया के डेमो  
...
यह MCP बिल्डर्स के लिए है। हम MCP सर्वर बनाने और उन्हें आपके AI वर्कफ़्लो में एकीकृत करने के लिए कार्यान्वयन रणनीतियों और सर्वोत्तम प्रथाओं में गहराई से जाएंगे।
...
गहन वीडियो सत्रों में सीखें कि MCP सर्वर कैसे बनाएं, VS कोड के साथ एकीकृत करें, और MCP फॉर बिगिनर्स पाठ्यक्रम की सामग्री के आधार पर Azure पर पेशेवर रूप से परिनियोजित करें।  
एक ऐसी तकनीक में व्यावहारिक कौशल के साथ बाहर निकलें जिसका उपयोग प्रमुख कंपनियां पहले से ही कर रही हैं।
...
चलो मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) के बारे में सीखते हैं, एक अत्याधुनिक फ्रेमवर्क जिसे AI मॉडल और क्लाइंट एप्लिकेशन के बीच इंटरैक्शन को मानकीकृत करने के लिए डिज़ाइन किया गया है।  
इस शुरुआती-अनुकूल सत्र के माध्यम से, हम आपको MCP से परिचित कराएंगे और आपके पहले MCP सर्वर को बनाने में मार्गदर्शन करेंगे।  
...
Microsoft Valued Professional [शिवम गोयल](https://www.linkedin.com/in/shivam2003/) को महत्वपूर्ण कोड नमूने योगदान करने के लिए धन्यवाद।  
...
Contributor License Agreement (CLA) से सहमत होना होगा, जिसमें यह घोषणा की जाती है कि आपके पास अधिकार हैं और आप हमें  
...
- **11-MCPServerHandsOnLabs/**: PostgreSQL इंटीग्रेशन के साथ प्रोडक्शन-रेडी MCP सर्वर बनाने के लिए पूरी 13-लैब सीखने की राह  
