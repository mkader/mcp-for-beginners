...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:40:12+00:00",
...
| 11.6 | MCP 伺服器實現 | 建立與數據庫整合的 FastMCP 伺服器 | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
準備好參加為期兩天的深入技術洞察、社群連結及動手學習的 MCP 開發者日活動，這是一個專注於模型上下文協議（MCP）的虛擬活動——這項新興標準旨在連接 AI 模型及其依賴的工具。
...
第一天旨在幫助開發者將 MCP 整合到開發工作流程中，並慶祝 MCP 社群的卓越成就。我們將與社群成員及合作夥伴（如 Arcade、Block、Okta 和 Neon）一起探討他們如何與 Microsoft 合作，共同塑造開放且可擴展的 MCP 生態系統。  
實際演示包括 VS Code、Visual Studio、GitHub Copilot 及流行社群工具  
實用的上下文驅動開發工作流程  
社群主導的會議及洞察  
...
第二天專為 MCP 建設者設計。我們將深入探討構建 MCP 伺服器的實現策略及最佳實踐，並將 MCP 整合到您的 AI 工作流程中。
...
### MCP 訓練營 2025 年 8 月
通過密集的視頻課程學習如何創建 MCP 伺服器、整合 VS Code 並基於 MCP 初學者課程內容在 Azure 上專業部署。掌握主要公司已經使用的技術的實用技能。
...
當您提交拉取請求時，CLA 機器人將自動判斷您是否需要提供 CLA 並適當地標記 PR（例如，狀態檢查、評論）。只需按照機器人提供的指示操作即可。您只需在所有使用我們 CLA 的存儲庫中完成一次此操作。
...
- **核心課程 (00-11)**：主要內容分為十一個連續模塊，包括全面的數據庫整合實驗
- **11-MCPServerHandsOnLabs/**：完整的 13 節實驗學習路徑，用於構建生產級 MCP 伺服器並整合 PostgreSQL
- **images/**：課程中使用的圖表及插圖
