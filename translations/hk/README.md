...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:37:28+00:00",
...
**模型上下文協議（MCP）** 是一個前沿框架，旨在標準化 AI 模型與客戶端應用程式之間的互動。本開源課程提供結構化的學習路徑，包含實際的程式碼範例和真實案例，涵蓋流行的程式語言如 C#、Java、JavaScript、TypeScript 和 Python。
...
| 3.8 | 測試 | 測試您的 MCP 伺服器實現 | [指南](./03-GettingStarted/08-testing/README.md) |
...
| **模組 4-5：實踐與高級主題** | | | |
| 04 | 實踐實現 | SDK、調試、測試、可重用的提示模板 | [了解更多](./04-PracticalImplementation/README.md) |
| 05 | MCP 的高級主題 | 多模態 AI、擴展、企業應用 | [了解更多](./05-AdvancedTopics/README.md) |
...
| 5.10 | 實時串流 | 建立實時串流功能 | [指南](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| **模組 11：MCP 伺服器實作實驗室** | | | |
| 11 | MCP 伺服器與資料庫整合 | 涵蓋 PostgreSQL 整合的完整 13 篇實作學習路徑 | [實驗室](./11-MCPServerHandsOnLabs/README.md) |
...
第一天旨在幫助開發者將 MCP 集成到開發工作流程中，並慶祝 MCP 社區的卓越成果。我們將與社區成員和合作夥伴（如 Arcade、Block、Okta 和 Neon）一起探討他們如何與 Microsoft 合作，共同打造開放且可擴展的 MCP 生態系統。  
...
### MCP 學習系列 - C# 教程
了解模型上下文協議（MCP），這是一個旨在標準化 AI 模型與客戶端應用之間交互的前沿框架。在這個面向初學者的課程中，我們將向您介紹 MCP 並指導您創建第一個 MCP 伺服器。
...
感謝 Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 提供重要代碼示例。
...
當您提交拉取請求時，CLA 機器人將自動確定您是否需要提供 CLA 並適當地標記 PR（例如，狀態檢查、評論）。只需按照機器人提供的指示操作即可。您只需在所有使用 CLA 的存儲庫中完成一次。
...
- **核心課程 (00-11)**：主要內容分為十一個連貫模塊，包括全面的數據庫集成實驗
...
- [**新** Edge AI 初學者課程](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
