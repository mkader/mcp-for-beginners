...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T14:56:56+00:00",
...
**Model Context Protocol (MCP)** ni mfumo wa kisasa ulioundwa kuunda viwango vya mawasiliano kati ya mifano ya AI na programu za wateja. Mtaala huu wa chanzo huria unatoa njia ya kujifunza iliyopangwa, ikijumuisha mifano ya vitendo ya nambari na matumizi ya ulimwengu halisi, katika lugha maarufu za programu kama C#, Java, JavaScript, TypeScript, na Python.
...
| 07 | Maarifa kutoka kwa Upitishaji wa Mapema | Hadithi za utekelezaji wa ulimwengu halisi | [Mwongozo](./07-LessonsFromEarlyAdoption/README.md) |
...
| 11 | Ujumuishaji wa Hifadhidata ya Seva ya MCP | Njia kamili ya mafunzo ya maabara 13 kwa ujumuishaji wa PostgreSQL | [Maabara](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | Utangulizi | Muhtasari wa MCP na ujumuishaji wa hifadhidata na matumizi ya uchambuzi wa rejareja | [Maabara 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.6 | Utekelezaji wa MCP Server | Kujenga seva ya FastMCP yenye ujumuishaji wa hifadhidata | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
| 11.8 | Utafutaji wa Kisemantiki | Kutekeleza embeddings za vector kwa kutumia Azure OpenAI na pgvector | [Lab 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
2. Mifano ya nambari ya moja kwa moja katika lugha mbalimbali  
...
Jiandae kwa siku mbili za maarifa ya kiufundi ya kina, muunganisho wa jamii, na kujifunza kwa vitendo katika MCP Dev Days, tukio la mtandaoni lililojitolea kwa Model Context Protocol (MCP) — kiwango kipya kinachounganisha mifano ya AI na zana wanazotegemea.
...
Ni kuhusu kuwawezesha watengenezaji kutumia MCP katika mtiririko wao wa kazi wa maendeleo na kusherehekea jamii ya ajabu ya MCP. Tutakuwa na wanachama wa jamii na washirika kama Arcade, Block, Okta, na Neon kuona jinsi wanavyoshirikiana na Microsoft kuunda mfumo wa MCP wazi na unaoweza kupanuka.  
...
Mkataba wa Leseni ya Mchango (CLA) unaotangaza kuwa una haki ya, na kwa kweli unatoa, haki kwetu
...
- **11-MCPServerHandsOnLabs/**: Njia kamili ya mafunzo ya maabara 13 ya kujenga seva za MCP zinazofaa kwa uzalishaji na ujumuishaji wa PostgreSQL
