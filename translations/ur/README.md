...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T22:07:31+00:00",
...
| 3.10 | جدید سرور کا استعمال | جدید خصوصیات کے استعمال اور بہتر فن تعمیر کے لیے جدید سرورز کا استعمال کریں | [گائیڈ](./03-GettingStarted/10-advanced/README.md) |
...
| 08 | MCP کے بہترین طریقے | کارکردگی، فالٹ ٹالرنس، لچک | [گائیڈ](./08-BestPractices/README.md) |
...
| 11.2 | بنیادی فن تعمیر | MCP سرور فن تعمیر، ڈیٹا بیس لیئرز، اور سیکیورٹی پیٹرنز کو سمجھنا | [لیب 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.4 | ماحول کی ترتیب | ترقیاتی ماحول، ڈاکر، اور Azure وسائل کی ترتیب | [لیب 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
...
| 11.6 | MCP سرور عمل درآمد | ڈیٹا بیس انضمام کے ساتھ FastMCP سرور بنانا | [لیب 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | ٹول ڈیولپمنٹ | ڈیٹا بیس کوئری ٹولز اور اسکیمہ انٹروسپیکشن بنانا | [لیب 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | سیمینٹک سرچ | Azure OpenAI اور pgvector کے ساتھ ویکٹر ایمبیڈنگز کا نفاذ | [لیب 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.10 | VS کوڈ انضمام | VS کوڈ MCP انضمام اور AI چیٹ کے استعمال کی ترتیب | [لیب 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
MCP ڈیولپر ڈیز کے لیے تیار ہو جائیں، دو دن کی گہری تکنیکی بصیرت، کمیونٹی کنکشن، اور عملی سیکھنے کے لیے وقف ایک ورچوئل ایونٹ جو ماڈل کانٹیکسٹ پروٹوکول (MCP) پر مرکوز ہے — ابھرتا ہوا معیار جو AI ماڈلز اور ان کے استعمال کردہ ٹولز کے درمیان پل بناتا ہے۔
...
Microsoft ویلیوڈ پروفیشنل [شِوام گوئل](https://www.linkedin.com/in/shivam2003/) کا شکریہ کہ انہوں نے اہم کوڈ نمونے فراہم کیے۔ 
...
[opencode@microsoft.com](mailto:opencode@microsoft.com) سے کسی بھی اضافی سوالات یا تبصروں کے ساتھ رابطہ کریں۔
...
- [C#/.NET ڈویلپرز کے لیے GitHub Copilot کو ماسٹر کرنا](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)  
...
[Microsoft کے ٹریڈ مارک اور برانڈ گائیڈ لائنز](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)  
