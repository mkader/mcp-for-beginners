...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T15:17:12+00:00",
...
Bez obzira da li ste AI programer, sistemski arhitekta ili softverski inženjer, ovaj vodič je vaš sveobuhvatan resurs za savladavanje osnova MCP-a i strategija implementacije.
...
| 02 | Bezbednost u MCP | Pretnje i najbolje prakse za bezbednost | [Pročitajte više](./02-Security/README.md) |
...
| 3.10 | Napredna upotreba servera | Koristite napredne servere za poboljšane funkcionalnosti i arhitekturu | [Vodič](./03-GettingStarted/10-advanced/README.md) |
...
| 5.4 | Osnovni konteksti | Razumevanje i implementacija osnovnih konteksta | [Vodič](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.8 | Bezbednost | Napredne bezbednosne razmatranja | [Vodič](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | Pretraga na internetu | Implementacija funkcionalnosti pretrage na internetu | [Vodič](./05-AdvancedTopics/web-search-mcp/README.md) |
...
| 07 | Uvidi iz rane primene | Priče o stvarnim implementacijama | [Vodič](./07-LessonsFromEarlyAdoption/README.md) |
...
| 11.3 | Безбедност и мултитенантност | Безбедност на нивоу реда, аутентификација и приступ подацима за више корисника | [Лабораторија 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
| 11.4 | Постављање окружења | Постављање развојног окружења, Docker, Azure ресурса | [Лабораторија 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
...
| 11.8 | Семантичка претрага | Имплементација векторских уградњи са Azure OpenAI и pgvector | [Лабораторија 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
Детаљан [Водич за учење](./study_guide.md) је доступан да вам помогне да ефикасно истражите овај репозиторијум. Водич укључује:
...
Посвећен је MCP програмерима. Дубоко ћемо се посветити стратегијама имплементације и најбољим праксама за креирање MCP сервера и интеграцију MCP-а у ваше AI процесе.
...
Хвала Microsoft Valued Professional [Шиваму Гојалу](https://www.linkedin.com/in/shivam2003/) на доприносу важним примерима кода. 
