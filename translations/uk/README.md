...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-07T00:20:37+00:00",
...
| 01 | Пояснення основних концепцій | Детальне дослідження основних концепцій MCP | [Детальніше](./01-CoreConcepts/README.md) |
...
| 3.11 | Простий авторизація | Розділ, що демонструє авторизацію з самого початку та RBAC | [Посібник](./03-GettingStarted/11-simple-auth/README.md) |
| **Модулі 4-5: Практичне та розширене** | | | |
| 04 | Практична реалізація | SDK, налагодження, тестування, шаблони запитів для повторного використання | [Детальніше](./04-PracticalImplementation/README.md) |
...
| 5.8 | Безпека | Розширені міркування щодо безпеки | [Посібник](./05-AdvancedTopics/mcp-security/README.md) |
...
| 5.12 | Авторизація Entra ID | Аутентифікація з Microsoft Entra ID | [Посібник](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| 11.1 | Вступ | Огляд MCP з інтеграцією бази даних та використанням аналітики роздрібної торгівлі | [Лабораторія 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | Безпека та мультиорендність | Безпека на рівні рядків, автентифікація та доступ до даних для кількох орендарів | [Лабораторія 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Проектування бази даних | Налаштування PostgreSQL, проектування схеми для роздрібної торгівлі та зразкові дані | [Лабораторія 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.7 | Розробка інструментів | Створення інструментів для запитів до бази даних та інспекції схеми | [Лабораторія 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | Семантичний пошук | Реалізація векторних вбудовувань за допомогою Azure OpenAI та pgvector | [Лабораторія 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.11 | Стратегії розгортання | Розгортання Docker, Azure Container Apps та аспекти масштабування | [Лабораторія 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
| TypeScript | Зразок для контейнера | [Переглянути код](./04-PracticalImplementation/samples/typescript/README.md) |
...
#### [День 2: Створюйте сервери MCP з упевненістю](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
- [Web Dev для початківців](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
- [IoT для початківців](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)
- [XR Development для початківців](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
...
[Керівництву Microsoft щодо торговельних марок і брендів](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
