...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T15:32:31+00:00",
...
- **6 HTTP стрімінг з MCP (Streamable HTTP)**. Дізнайтеся про сучасний HTTP стрімінг, сповіщення про прогрес і як реалізувати масштабовані, реальні MCP сервери та клієнти за допомогою Streamable HTTP, [до уроку](06-http-streaming/README.md)
...
Протокол Model Context Protocol (MCP) — це відкритий протокол, який стандартизує спосіб надання контексту додатками для LLM. Уявіть MCP як порт USB-C для AI додатків — він забезпечує стандартизований спосіб підключення AI моделей до різних джерел даних і інструментів.
...
У нас є набір прикладів, які доповнюють вправи, що ви побачите у всіх розділах цього розділу. Крім того, кожен розділ також має свої власні вправи та завдання.
