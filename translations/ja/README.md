...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:42:50+00:00",
...
- 🌐 [MCPコミュニティ](https://github.com/orgs/modelcontextprotocol/discussions) – コミュニティに参加して貢献
...
| **モジュール3: 初めてのサーバーとクライアント構築** | | | |
| 3.1 | 初めてのサーバー | MCPサーバーを初めて作成 | [ガイド](./03-GettingStarted/01-first-server/README.md) |
...
| 3.5 | stdioサーバー | stdioトランスポートを使用したサーバーを作成 | [ガイド](./03-GettingStarted/05-stdio-server/README.md) |
...
| 3.8 | テスト | MCPサーバーの実装をテスト | [ガイド](./03-GettingStarted/08-testing/README.md) |
| 3.9 | デプロイメント | MCPサーバーを本番環境にデプロイ | [ガイド](./03-GettingStarted/09-deployment/README.md) |
| 3.10 | 高度なサーバー使用 | 高度な機能と改善されたアーキテクチャを使用するためのサーバー | [ガイド](./03-GettingStarted/10-advanced/README.md) |
| **モジュール4-5: 実践 & 高度な内容** | | | |
...
| 5.4 | ルートコンテキスト | ルートコンテキストを理解して実装 | [ガイド](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.7 | スケーリング | MCPの実装をスケールアップ | [ガイド](./05-AdvancedTopics/mcp-scaling/README.md) |
...
| 5.12 | Entra ID認証 | Microsoft Entra IDで認証 | [ガイド](./05-AdvancedTopics/mcp-security-entra/README.md) |
| 5.13 | Foundry統合 | Azure AI Foundryと統合 | [ガイド](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 10 | 実践ワークショップ | AIツールキットを使ったMCPサーバー構築 | [ラボ](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
| **モジュール11: MCPサーバー実践ラボ** | | | |
| 11 | MCPサーバーデータベース統合 | PostgreSQL統合のための包括的な13ラボ学習パス | [ラボ](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | はじめに | MCPとデータベース統合の概要、リテール分析ユースケース | [ラボ00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.6 | MCPサーバーの実装 | データベース統合を含むFastMCPサーバーの構築 | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
| 11.12 | モニタリング | Application Insights、ログ記録、パフォーマンスモニタリング | [Lab 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
...
このカリキュラムを最大限活用するために、以下の知識があると良いでしょう：
...
このリポジトリには、効果的に学習を進めるためのリソースが多数含まれています：

### 学習ガイド

包括的な[学習ガイド](./study_guide.md)が利用可能で、このリポジトリを効果的に活用する方法を案内します。ガイドには以下が含まれます：

- カバーされるトピックのビジュアルカリキュラムマップ
- 各リポジトリセクションの詳細な内訳
...
#### [Day 2: MCPサーバーを自信を持って構築する](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
開発者、ツール構築者、AI製品戦略家の方にとって、スケーラブルで安全、そして将来に対応したMCPソリューションを構築するための洞察が詰まった日です。
...
### Let's Learn MCP with C# - チュートリアルシリーズ
...
重要なコードサンプルを提供してくださったMicrosoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/)さんに感謝します。
...
このプロジェクトは貢献と提案を歓迎します。ほとんどの貢献には、コントリビューターライセンス契約（CLA）に同意する必要があります。これにより、貢献する権利があり、実際に貢献を使用する権利を提供することを宣言します。詳細については、<https://cla.opensource.microsoft.com>をご覧ください。
...
詳細については、[Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/)をご覧いただくか、[opencode@microsoft.com](mailto:opencode@microsoft.com)まで追加の質問やコメントをお寄せください。

## 📂 リポジトリ構造

リポジトリは以下のように構成されています：

- **Core Curriculum (00-11)**: 11の順序付けられたモジュールに整理された主要コンテンツ、包括的なデータベース統合ラボを含む
...
このプロジェクトの改変版でMicrosoftの商標やロゴを使用する場合、混乱を招いたり、Microsoftの後援を示唆したりしてはなりません。  
