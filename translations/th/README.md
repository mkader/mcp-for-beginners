...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T14:24:59+00:00",
...
| 11 | การผสานรวมฐานข้อมูล MCP Server | เส้นทางการเรียนรู้แบบลงมือทำ 13 ห้องปฏิบัติการสำหรับการผสานรวม PostgreSQL | [ห้องปฏิบัติการ](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | บทนำ | ภาพรวมของ MCP พร้อมการผสานรวมฐานข้อมูลและกรณีการใช้งานการวิเคราะห์การค้าปลีก | [ห้องปฏิบัติการ 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.7 | การพัฒนาเครื่องมือ | การสร้างเครื่องมือสอบถามฐานข้อมูลและการตรวจสอบสคีมา | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
เน้นการเพิ่มพลังให้กับนักพัฒนาในการใช้ MCP ในกระบวนการพัฒนา และเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะมีสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta, และ Neon ที่จะมาแสดงให้เห็นว่าพวกเขาร่วมมือกับ Microsoft อย่างไรเพื่อสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้  
...
สำหรับผู้สร้าง MCP เราจะเจาะลึกกลยุทธ์การใช้งานและแนวปฏิบัติที่ดีที่สุดสำหรับการสร้าง MCP servers และการรวม MCP เข้ากับกระบวนการทำงาน AI ของคุณ
...
เรียนรู้ในเซสชันวิดีโอเข้มข้นเกี่ยวกับวิธีการสร้าง MCP servers, การรวมเข้ากับ VS Code, และการปรับใช้อย่างมืออาชีพบน Azure โดยอิงจากเนื้อหาหลักสูตร MCP สำหรับผู้เริ่มต้น ออกไปพร้อมทักษะที่ใช้งานได้จริงในเทคโนโลยีที่บริษัทใหญ่ๆ กำลังใช้งานอยู่
...
มาเรียนรู้เกี่ยวกับ Model Context Protocol (MCP) ซึ่งเป็นกรอบงานล้ำสมัยที่ออกแบบมาเพื่อมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันลูกค้า ผ่านเซสชันที่เป็นมิตรกับผู้เริ่มต้น เราจะนำคุณเข้าสู่ MCP และแนะนำวิธีการสร้าง MCP server แรกของคุณ
...
- **11-MCPServerHandsOnLabs/**: เส้นทางการเรียนรู้ 13 ห้องปฏิบัติการสำหรับการสร้าง MCP servers ที่พร้อมใช้งานจริงด้วยการรวม PostgreSQL
...
- [**ใหม่** Edge AI For Beginners](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
