...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T15:20:19+00:00",
...
[![GitHub forkovi](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
1. **Forkajte repozitorij**: Kliknite [![GitHub forkovi](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
Bez obzira jeste li AI programer, arhitekt sustava ili softverski inženjer, ovaj vodič je vaš sveobuhvatni resurs za savladavanje MCP osnova i strategija implementacije.
...
| 02 | Sigurnost u MCP | Prijetnje sigurnosti i najbolje prakse | [Pročitajte više](./02-Security/README.md) |
| 03 | Početak rada s MCP | Postavljanje okruženja, osnovni serveri/klijenti, integracija | [Pročitajte više](./03-GettingStarted/README.md) |
...
| 3.7 | AI Toolkit | Koristite AI Toolkit s MCP | [Vodič](./03-GettingStarted/07-aitk/README.md) |
...
| 3.10 | Napredna upotreba servera | Koristite napredne servere za napredne značajke i poboljšanu arhitekturu | [Vodič](./03-GettingStarted/10-advanced/README.md) |
...
| 05 | Napredne teme u MCP | Multimodalni AI, skaliranje, primjena u poduzećima | [Pročitajte više](./05-AdvancedTopics/README.md) |
| 5.1 | Integracija s Azure | MCP integracija s Azure | [Vodič](./05-AdvancedTopics/mcp-integration/README.md) |
...
| 5.5 | Usmjeravanje | Strategije usmjeravanja u MCP | [Vodič](./05-AdvancedTopics/mcp-routing/README.md) |
...
| 5.13 | Integracija s Foundry | Integracija s Azure AI Foundry | [Vodič](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 10 | Radionica | Izrada MCP servera s AI Toolkit | [Laboratorij](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
| **Modul 11: MCP Server Hands On Lab** | | | |
| 11 | Integracija MCP servera s bazom podataka | Sveobuhvatan put učenja kroz 13 laboratorija za integraciju s PostgreSQL | [Laboratoriji](./11-MCPServerHandsOnLabs/README.md) |
...
Naučimo o Model Context Protocolu (MCP), naprednom okviru dizajniranom za standardizaciju interakcija između AI modela i klijentskih aplikacija. Kroz ovu sesiju prilagođenu početnicima, upoznat ćemo vas s MCP-om i voditi kroz stvaranje vašeg prvog MCP poslužitelja.
...
Zahvaljujemo Microsoft Valued Professionalu [Shivamu Goyalu](https://www.linkedin.com/in/shivam2003/) na doprinosu važnim uzorcima koda. 
...
Contributor License Agreement (CLA) koji izjavljuje da imate pravo i stvarno dajete prava za korištenje vašeg doprinosa. Za detalje, posjetite <https://cla.opensource.microsoft.com>.
...
- **11-MCPServerHandsOnLabs/**: Kompletan put učenja od 13 laboratorija za izgradnju MCP poslužitelja spremnih za produkciju s integracijom PostgreSQL-a
