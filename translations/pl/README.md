...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T22:57:54+00:00",
...
| 3.10 | Zaawansowane użycie serwera | Korzystanie z zaawansowanych serwerów dla zaawansowanych funkcji i ulepszonej architektury | [Przewodnik](./03-GettingStarted/10-advanced/README.md) |
| 3.11 | Prosta autoryzacja | Rozdział pokazujący autoryzację od podstaw i RBAC | [Przewodnik](./03-GettingStarted/11-simple-auth/README.md) |
...
| 5.12 | Autoryzacja Entra ID | Uwierzytelnianie za pomocą Microsoft Entra ID | [Przewodnik](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| 08 | Najlepsze praktyki dla MCP | Wydajność, odporność na błędy, odporność | [Przewodnik](./08-BestPractices/README.md) |
...
| 11 | Integracja serwera MCP z bazą danych | Kompleksowa ścieżka nauki w 13 laboratoriach dla integracji z PostgreSQL | [Laboratoria](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | Architektura rdzenia | Zrozumienie architektury serwera MCP, warstw bazy danych i wzorców bezpieczeństwa | [Lab 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | Bezpieczeństwo i wielodostępność | Bezpieczeństwo na poziomie wiersza, uwierzytelnianie i dostęp do danych dla wielu najemców | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.6 | Implementacja serwera MCP | Tworzenie serwera FastMCP z integracją bazy danych | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
| 11.9 | Testowanie i debugowanie | Strategie testowania, narzędzia debugowania i podejścia do walidacji | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
| 11.10 | Integracja z VS Code | Konfiguracja integracji MCP z VS Code i korzystanie z AI Chat | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
Przygotuj się na dwa dni głębokich wglądów technicznych, połączeń społecznościowych i praktycznej nauki podczas MCP Dev Days, wirtualnego wydarzenia poświęconego Model Context Protocol (MCP) — nowemu standardowi łączącemu modele AI i narzędzia, na których się opierają.
...
#### [➡️ Obejrzyj na żądanie MCP Bootcamp | Brazylia](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
