...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:21:06+00:00",
...
| 01 | Объяснение основных концепций | Подробное изучение ключевых концепций MCP | [Подробнее](./01-CoreConcepts/README.md) |
...
| **Модули 4-5: Практика и углубленные темы** | | | |
| 04 | Практическая реализация | SDK, отладка, тестирование, шаблоны запросов | [Подробнее](./04-PracticalImplementation/README.md) |
| 05 | Углубленные темы MCP | Мультимодальный AI, масштабирование, корпоративное использование | [Подробнее](./05-AdvancedTopics/README.md) |
...
| 5.8 | Безопасность | Углубленные аспекты безопасности | [Руководство](./05-AdvancedTopics/mcp-security/README.md) |
...
| 11 | Интеграция сервера MCP с базой данных | Полный учебный путь из 13 лабораторий для интеграции PostgreSQL | [Лаборатории](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | Основная архитектура | Понимание архитектуры сервера MCP, слоев базы данных и шаблонов безопасности | [Лаборатория 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.5 | Проектирование базы данных | Настройка PostgreSQL, проектирование схемы для розничной торговли и пример данных | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | Реализация MCP сервера | Создание FastMCP сервера с интеграцией базы данных | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
| 11.8 | Семантический поиск | Реализация векторных эмбеддингов с Azure OpenAI и pgvector | [Lab 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.11 | Стратегии развертывания | Развертывание с Docker, Azure Container Apps и масштабирование | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
- Присоединение к обсуждениям в нашем сообществе для получения поддержки
