...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T21:53:42+00:00",
...
- 📜 [Especificación original de MCP](https://spec.modelcontextprotocol.io/) – Referencias técnicas antiguas (pueden contener detalles adicionales)  
...
| 5.3 | Demostración de OAuth2 | Implementa autenticación OAuth2 | [Guía](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
...
| 10 | Taller Práctico | Construyendo un Servidor MCP con Toolkit de IA | [Laboratorio](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| 11.1 | Introducción | Resumen de MCP con integración de base de datos y caso de uso de análisis de ventas minoristas | [Laboratorio 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | Seguridad y Multitenencia | Seguridad a nivel de fila, autenticación y acceso a datos multi-tenant | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Diseño de Base de Datos | Configuración de PostgreSQL, diseño de esquema para retail y datos de ejemplo | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
- [Domina GitHub Copilot para desarrolladores de C#/.NET](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
