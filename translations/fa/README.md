...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T22:04:28+00:00",
...
| 04 | پیاده‌سازی عملی | SDKها، اشکال‌زدایی، تست، قالب‌های درخواست قابل استفاده مجدد | [بیشتر بخوانید](./04-PracticalImplementation/README.md) |
...
| 11.1 | مقدمه | مرور کلی MCP با یکپارچه‌سازی پایگاه داده و مورد استفاده تحلیل‌های خرده‌فروشی | [آزمایشگاه 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | معماری اصلی | درک معماری سرور MCP، لایه‌های پایگاه داده و الگوهای امنیتی | [آزمایش 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | امنیت و چند مستاجری | امنیت در سطح ردیف، احراز هویت و دسترسی به داده‌های چند مستاجری | [آزمایش 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
| 11.4 | تنظیم محیط | راه‌اندازی محیط توسعه، Docker، منابع Azure | [آزمایش 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
| 11.5 | طراحی پایگاه داده | تنظیم PostgreSQL، طراحی طرح خرده‌فروشی و داده‌های نمونه | [آزمایش 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | پیاده‌سازی سرور MCP | ساخت سرور FastMCP با یکپارچه‌سازی پایگاه داده | [آزمایش 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | توسعه ابزار | ایجاد ابزارهای پرس‌وجوی پایگاه داده و بررسی طرح | [آزمایش 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | جستجوی معنایی | پیاده‌سازی جاسازی برداری با Azure OpenAI و pgvector | [آزمایش 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
| 11.9 | آزمایش و اشکال‌زدایی | استراتژی‌های آزمایش، ابزارهای اشکال‌زدایی و روش‌های اعتبارسنجی | [آزمایش 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
| 11.10 | یکپارچه‌سازی VS Code | تنظیم یکپارچه‌سازی MCP در VS Code و استفاده از چت هوش مصنوعی | [آزمایش 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | استراتژی‌های استقرار | استقرار Docker، برنامه‌های کانتینری Azure و ملاحظات مقیاس‌پذیری | [آزمایش 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | نظارت | Application Insights، ثبت وقایع، نظارت بر عملکرد | [آزمایش 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
| 11.13 | بهترین روش‌ها | بهینه‌سازی عملکرد، تقویت امنیت و نکات تولید | [آزمایش 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
ما یک [تغییرات](./changelog.md) دقیق را نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد آموزشی را دنبال می‌کند، از جمله:
...
#### [➡️تماشا به صورت درخواستی کمپ آموزشی MCP | انگلیسی](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
#### [➡️تماشا به صورت درخواستی کمپ آموزشی MCP | برزیل](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
#### [➡️تماشا به صورت درخواستی کمپ آموزشی MCP | اسپانیایی](https://developer.microsoft.com/en-us/reactor/series/S-1567/)
