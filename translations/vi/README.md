...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T23:30:29+00:00",
...
| 3.11 | Xác thực đơn giản | Một chương trình hướng dẫn bạn về xác thực từ đầu và RBAC | [Hướng dẫn](./03-GettingStarted/11-simple-auth/README.md) |
...
| 11.2 | Kiến trúc cốt lõi | Hiểu về kiến trúc máy chủ MCP, các lớp cơ sở dữ liệu và mô hình bảo mật | [Lab 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.5 | Thiết kế cơ sở dữ liệu | Cài đặt PostgreSQL, thiết kế sơ đồ bán lẻ và dữ liệu mẫu | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.7 | Phát triển công cụ | Tạo công cụ truy vấn cơ sở dữ liệu và kiểm tra sơ đồ | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
Cảm ơn Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) đã đóng góp các mẫu mã nguồn quan trọng.
...
- [Làm chủ GitHub Copilot dành cho các nhà phát triển C#/.NET](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
...
Dự án này có thể chứa các thương hiệu hoặc logo liên quan đến các dự án, sản phẩm, hoặc dịch vụ. Việc sử dụng hợp pháp các thương hiệu hoặc logo của Microsoft phải tuân theo và phù hợp với 
