...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T13:45:59+00:00",
...
3. [**Azure AI Foundry Discord에 가입하여 전문가 및 개발자들과 만나보세요**](https://discord.com/invite/ByRwuEEgH4)
...
AI 개발자, 시스템 아키텍트, 소프트웨어 엔지니어라면 MCP의 기본 개념과 구현 전략을 마스터하기 위한 종합적인 리소스를 이 가이드에서 확인할 수 있습니다.
...
이 저장소에는 효과적으로 학습할 수 있도록 돕는 다양한 리소스가 포함되어 있습니다:

### 학습 가이드

포괄적인 [학습 가이드](./study_guide.md)가 제공되어 저장소를 효과적으로 탐색할 수 있도록 돕습니다. 가이드에는 다음이 포함됩니다:
...
#### [➡️ MCP Dev Days 다시 보기](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
실제 VS Code, Visual Studio, GitHub Copilot 및 인기 있는 커뮤니티 도구를 활용한 데모  
...
MCP 구축자를 위한 날입니다. MCP 서버를 생성하고 이를 AI 워크플로우에 통합하는 구현 전략 및 모범 사례를 깊이 있게 다룹니다.
...
### MCP 부트캠프 2025년 8월
MCP 서버를 생성하고 VS Code와 통합하며 Azure에서 전문적으로 배포하는 방법을 MCP 초급 커리큘럼의 내용을 기반으로 한 집중 비디오 세션에서 배워보세요. 주요 기업들이 이미 사용하고 있는 기술에 대한 실용적인 기술을 얻을 수 있습니다.

#### [➡️ MCP 부트캠프 다시 보기 | 영어](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
#### [➡️ MCP 부트캠프 다시 보기 | 브라질](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
#### [➡️ MCP 부트캠프 다시 보기 | 스페인어](https://developer.microsoft.com/en-us/reactor/series/S-1567/)

### C#으로 MCP 배우기 - 튜토리얼 시리즈
AI 모델과 클라이언트 애플리케이션 간의 상호작용을 표준화하기 위해 설계된 최첨단 프레임워크인 Model Context Protocol (MCP)에 대해 알아보세요. 초보자 친화적인 세션을 통해 MCP를 소개하고 첫 MCP 서버를 만드는 과정을 안내합니다.
...
이 프로젝트는 프로젝트, 제품 또는 서비스에 대한 상표나 로고를 포함할 수 있습니다. Microsoft 상표나 로고의 허가된 사용은 [Microsoft의 상표 및 브랜드 지침](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)을 준수해야 합니다. 이 프로젝트의 수정된 버전에서 Microsoft 상표나 로고를 사용하는 경우 혼란을 초래하거나 Microsoft의 후원을 암시해서는 안 됩니다. 제3자 상표나 로고의 사용은 해당 제3자의 정책을 따라야 합니다.
